...
import com.jielong.core.service.SmsService;
...
public class SmsServiceImpl implements SmsService {
	 ...
	 */
	@Override
	public ResponseBean<String> sendVerCodeSMS(String phoneNumber, String templateCode) {
		...
		IAcsClient acsClient = new DefaultAcsClient(profile);
		 ...
		 //6位验证码
		 String code=Utils.createRandomNum(6);
